...
<body>
	...
	<section class="page-section" id="contact">
		...
		-->
					...
					<form action="RecipeWritePro.co" name="recipeForm" method="post"
						enctype="multipart/form-data">
						<!-- 닉네임 -->
						<div class="form-floating mb-3">
							<input class="form-control" type="text" name="nickname"
								id="nickname" placeholder="닉네임을 입력해달라!"
								value="${sessionScope.sNickName }" readonly="readonly">
							<label for="nickname">어맛인</label>
						</div>
						<!-- 제목 -->
						<div class="form-floating mb-3">
							<input class="form-control" type="text" name="subject"
								id="subject" placeholder="제목을 입력해주세요!" maxlength="50"> <label
						...
						<div class="form-floating sm-3">
							<input class="form-control" type="file" required="required"
								name="file1" multiple="multiple"
								accept="image/gif, image/jpg, image/png, image/jpeg"
								onchange="fileCheck(this)"> <label for="file">파일1</label>
						</div>
						<div class="form-floating sm-3">
							<input class="form-control" type="file" name="file2"
								multiple="multiple"
								accept="image/gif, image/jpg, image/png, image/jpeg"
								onchange="fileCheck(this)"> <label for="file">파일2</label>
						</div>
						<div class="form-floating sm-3">
							<input class="form-control" type="file" name="file3"
								multiple="multiple"
								accept="image/gif, image/jpg, image/png, image/jpeg"
								onchange="fileCheck(this)"> <label for="file">파일3</label>
						</div>
						<div class="form-floating sm-3">
							<input class="form-control" type="file" name="file4"
								multiple="multiple"
								accept="image/gif, image/jpg, image/png, image/jpeg"
								onchange="fileCheck(this)"> <label for="file">파일4</label>
						</div>
						<div class="form-floating sm-3">
							<input class="form-control" type="file" name="file5"
								multiple="multiple"
								accept="image/gif, image/jpg, image/png, image/jpeg"
								onchange="fileCheck(this)"> <label for="file">파일5</label>
						</div>
						...
						<div align="right">
							...
							<input type="button" class="btn btn-secondary" value="메인"
								onclick="location.href='./'"> <input type="button"
								class="btn btn-secondary" value="취소" onclick="history.back()">
						</div>
					</form>
				</div>
			</div>
